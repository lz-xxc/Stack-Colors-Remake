...
public class WindowMgr : Singleton<WindowMgr> {
    ...
    public MaskItemView GetMaskView(Transform winTR, float alpha) {
...
public class MaskItemView {
    ...
    public MaskItemView(GameObject _itemGO) {
        ItemGO = _itemGO;
        imgMask = ItemGO.GetComponent<Image>();
    }

    public void SetData(Transform winTR, float alpha) {
