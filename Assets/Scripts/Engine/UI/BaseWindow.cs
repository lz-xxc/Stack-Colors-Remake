...
public class BaseWindow : MonoBehaviour
{
    ...
    private void PlayOpenAnim()
    {
        ...
        switch (windowInfo.openAnimType)
        {
            ...
            case OpenAnimType.Scale:
                ...
                tweener = gameObject.transform.DOScale(1, windowInfo.animTime).SetEase(windowInfo.openEase).SetUpdate(true);
                break;
    ...
    private void PlayCloseAnim()
    {
        ...
        switch (windowInfo.closeAnimType)
        {
            ...
            case OpenAnimType.Position:
                ...
                break;
            case OpenAnimType.Scale:
                tweener = gameObject.transform.DOScale(0, windowInfo.animTime).SetEase(windowInfo.closeEase).SetUpdate(true);
                break;
            case OpenAnimType.Alpha:
    ...
    private void AddMask()
    {
        ...
        mask = WindowMgr.Instance.GetMaskView(transform, windowInfo.maskAlpha);
    }
